...
// Hybrid-BV counterparts of the C macros.  Contracts below state explicitly
// where their mathematical alignment properties are required when the
// Int/BV conversion is kept opaque.
